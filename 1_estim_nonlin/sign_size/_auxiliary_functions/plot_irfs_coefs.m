function plot_irfs_coefs(irfs_plot,horizon,vars_plot,varNames_paper,non_lin_name,save_figs)
...
irf_se_linear_upper_1 = irf_coefs_linear+significance_factor_1*irf_se_linear;
irf_se_linear_lower_1 = irf_coefs_linear-significance_factor_1*irf_se_linear;
irf_se_linear_upper_2 = irf_coefs_linear+significance_factor_2*irf_se_linear;
irf_se_linear_lower_2 = irf_coefs_linear-significance_factor_2*irf_se_linear;
else
% get the t_stats of the non-linear terms
...
irf_se_linear_upper_1 = irf_coefs_linear+significance_factor_1*irf_se_linear;
irf_se_linear_lower_1 = irf_coefs_linear-significance_factor_1*irf_se_linear;
irf_se_non_linear_upper_1 = irf_coefs_non_linear+significance_factor_1*irf_se_non_linear;
irf_se_non_linear_lower_1 = irf_coefs_non_linear-significance_factor_1*irf_se_non_linear;
irf_se_linear_upper_2 = irf_coefs_linear+significance_factor_2*irf_se_linear;
irf_se_linear_lower_2 = irf_coefs_linear-significance_factor_2*irf_se_linear;
irf_se_non_linear_upper_2 = irf_coefs_non_linear+significance_factor_2*irf_se_non_linear;
irf_se_non_linear_lower_2 = irf_coefs_non_linear-significance_factor_2*irf_se_non_linear;
end
dataFrequency = 'M';
...
if save_figs == 1
    saveas(gcf,strcat('_results/irf_linear_coef_',non_lin_name),'png')
end
...
set(h_plot,'Visible','off');
if save_figs ==1
saveas(gcf,strcat('_results/irf_non_linear_coef_',non_lin_name),'png')
end

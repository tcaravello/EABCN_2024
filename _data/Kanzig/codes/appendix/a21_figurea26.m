...
% This file generates figure A.26
...
% names for paper
varNames_paper = {'Real oil price','World oil production','World oil inventories','World industrial production'}; %'Global activity'};
...
tightfig;
if saveFigs
    print('-dpdf', gcf, '../../results/appendix/figurea26');  
end

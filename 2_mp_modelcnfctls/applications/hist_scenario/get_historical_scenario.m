...
hold on
for i_model = 1:n_models
    plot(date_ext(fcst_date-fcst_lag):0.25:date_ext(fcst_date+fcst_hor),pi_cnfctl_models(:,i_model),'-','Color',settings.colors.models(i_model,:),'LineWidth',4)
    hold on
end
...
hold on
for i_model = 1:n_models
    plot(date_ext(fcst_date-fcst_lag):0.25:date_ext(fcst_date+fcst_hor),y_cnfctl_models(:,i_model),'-','Color',settings.colors.models(i_model,:),'LineWidth',4)
    hold on
end
xlim([date_ext(fcst_date-fcst_lag),date_ext(fcst_date+fcst_hor)])
set(gcf,'color','w')
...
hold on
for i_model = 1:n_models
    plot(date_ext(fcst_date-fcst_lag):0.25:date_ext(fcst_date+fcst_hor),i_cnfctl_models(:,i_model),'-','Color',settings.colors.models(i_model,:),'LineWidth',4)
    hold on
end
xlim([date_ext(fcst_date-fcst_lag),date_ext(fcst_date+fcst_hor)])
set(gcf,'color','w')
...
set(gcf, 'Position', [0.5*pos(1) 0.5*pos(2) 2.25*pos(3) 1.25*pos(4)]);

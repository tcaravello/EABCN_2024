...
task = '/irf_matching';
model = '/hank'; %type '/rank' for RANK, '/hank' for HANK
...
N_adapt = 20000; % number of draws to estimate draw covariance matrix. If you wanna turn off set N_adapt = 0
N_burn = N_adapt + 5000; % number of draws to burn
N_keep = 1000;  % number of matrix draws to keep.
keep_every = 10; %this means that we store 1 out of keep_every draws

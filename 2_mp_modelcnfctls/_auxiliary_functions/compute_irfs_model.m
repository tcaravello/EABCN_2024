% NOTE: THIS SCRIPT IS NOT ACTUALLY CALLED DURING ESTIMATION, JUST USED FOR
% EXPOSITIONAL PURPOSES. THE FUNCTIONS ACTUALLY CALLED ARE LOCATED IN THE
% solve_model.m SCRIPT.
